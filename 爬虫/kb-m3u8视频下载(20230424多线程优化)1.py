...
"""
https://www.ailianlove.com/yqxm/42653.html
"""
episode = ''
url = f'https://www.bei-fa.com/vodplay/36867-1-{episode}.html'
url1 = 'https://hd.lz-cdn18.com/20230127/197_e1fe4c05/2000k/hls/'
...
def load_m3u8_file(episode):
    ...
    ts_line_list = []
    m3u8_file_path = f"D:/pythonProject/爬虫/movie/m3u8/28-2.m3u8"

    with open(m3u8_file_path, 'r') as f:
        for ts_line in f:
            if not ts_line.startswith("#"):
                ts_line = url1 + ts_line.strip()
