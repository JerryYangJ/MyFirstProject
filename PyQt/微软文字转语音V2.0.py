"""
@author: JerryYang
@file: 微软文字转语音V2.0.py.py
@time: 2023/4/21 8:21
@desc: 使用pygame模块播放合成后的语音
        需优化点：播放完成后，试听按钮不能自动复位
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.test_bt_text_ls = ['试听', '停止']
        self.test_bt_clickcount = 2
        self.path = ''
        ...
        self.stop_Button.setGeometry(QtCore.QRect(820, 510, 251, 51))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "微软文字转语音v2.0    制作：Jerry Yang"))
    ...
    def do_Button_click(self):
        ...
        if self.tabWidget.currentIndex() == 0:
            ...
            if not text:
                ...
                asyncio.run(self.transfor(text, voice, self.path, rate))
