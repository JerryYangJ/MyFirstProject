...
class Ui_QMS(object):
    ...
    def retranslateUi(self, QMS):
        ...
        QMS.setWindowTitle(_translate("QMS", "QMS检验记录与生产订单匹配检查程序  制作：Jerry Y  版本：测试版"))
    ...
    def lineEdit_setText(self):
        ...
        file, type = QFileDialog.getOpenFileName(None, "请选择文件", "D:/")   # Text File (*.txt)为文件过滤器
        # print(file, type)
